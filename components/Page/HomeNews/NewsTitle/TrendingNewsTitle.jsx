...
const TrendingNewsTitle = () => {
  const latestNewsTitleArray = [
    ...
    {
      id: 5,
      title: "সেনা, পুলিশ, র‍্যাবের চাকরিচ্যুত ব্যক্তিদের নিয়ে গঠিত যে ডাকাত দল"
    },
    {
      id: 6,
    ...
    {
      id: 10,
      title: "প্রতিমন্ত্রীর প্রতিনিধি ডিবি কার্যালয়ে গিয়ে চাকরি প্রার্থীদের টাকা ফেরত দিলেন"
    },
    {
      id: 11,
